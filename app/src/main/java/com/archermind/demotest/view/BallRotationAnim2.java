 ...
 * 两个小球旋转动画
 */
public class BallRotationAnim2 extends View {
    ...
    public BallRotationAnim2(Context context) {
        this(context, null);
    }

    public BallRotationAnim2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BallRotationAnim2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
